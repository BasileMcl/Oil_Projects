...
Portfolio-wide styling: [../plot_config.yaml](../plot_config.yaml). Event timeline: [../major_dates.yaml](../major_dates.yaml). Data layer: [../data/](../data/). Term definitions: [../GLOSSARY.md](../GLOSSARY.md).
...
- **Portfolio coding standards**: [../../rules/coding_standards.md](../../rules/coding_standards.md)
- **Geopolitical event timeline**: [../major_dates.yaml](../major_dates.yaml)
- **Shared data layer** (incl. 181+ new OPEC / Refining files): [../data/](../data/)
